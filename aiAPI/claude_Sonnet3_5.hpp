                      ...
                      size_t chunkSize = 30000, int max_tokens = 4096)
    {
        ...
        for (size_t i = 0; i < totalChunks; ++i)
        {
            ...
            std::string chunkPrompt = std::string(analysisInstruction) +
                "\n\n[파트 " + std::to_string(i + 1) + "/" + std::to_string(totalChunks) + "]\n\n" + chunk;
